...
//       Status: report.isAbsent ? 'Absent' : 'Present',
//       'In Time': report.isAbsent ? '-' : (report.inTime ?? '-'),
//       'Out Time': report.isAbsent ? '-' : (report.outTime ?? '-'),
//       'Late (min)': report.isAbsent ? '-' : (report.lateInMinutes ?? 0),
//       'Early Out (min)':
//         report.isAbsent ? '-' : (report.earlyOutMinutes ?? 0),
//     }))
...
//                       const isAbsent = Boolean(report.isAbsent)
//                       const hasIssue =
//                         !isAbsent &&
